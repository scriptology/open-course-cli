use open_course_core::language::normalize_language_code;
...
pub struct SettingsLabels {
    ...
    pub err_model_required: &'static str,
    pub section_account: &'static str,
    pub account_not_logged_in: &'static str,
    pub account_sign_in: &'static str,
    pub account_sign_in_retry: &'static str,
    pub account_starting: &'static str,
    pub account_code_label: &'static str,
    pub account_verification_label: &'static str,
    pub account_waiting: &'static str,
    pub account_expired: &'static str,
    ...
    pub account_never_synced: &'static str,
    pub account_pending_label: &'static str,
    pub account_sync_now: &'static str,
    pub account_sync_toggle_label: &'static str,
    pub account_sync_on: &'static str,
    pub account_sync_off: &'static str,
    pub account_sign_out: &'static str,
    pub account_syncing: &'static str,
    pub account_sync_done: &'static str,
    pub account_sync_done_toast: &'static str,
    pub account_sync_failed: &'static str,
    pub account_sync_conflict: &'static str,
    pub account_sync_conflict_toast: &'static str,
    pub account_relogin_required: &'static str,
    pub account_sync_block_title: &'static str,
    pub account_synced_items: &'static str,
    pub account_not_synced_items: &'static str,
    pub account_bind_checking: &'static str,
    pub account_conflict_title: &'static str,
    pub account_conflict_topics: &'static str,
    pub account_conflict_adopt: &'static str,
    pub account_conflict_replace: &'static str,
    pub account_conflict_cancel: &'static str,
    pub account_progress_merge_title: &'static str,
    pub account_progress_merge_merge: &'static str,
    pub account_progress_merge_cloud: &'static str,
    pub account_adopt_done: &'static str,
    pub account_replace_done: &'static str,
}
...
const EN_SETTINGS: SettingsLabels = SettingsLabels {
    ...
    account_sign_in_retry: "Retry sign in",
    account_starting: "Starting sign in...",
    account_code_label: "Code:",
    account_verification_label: "Open:",
    account_waiting: "Waiting for confirmation in the browser...",
    account_expired: "The code expired.",
    ...
    account_never_synced: "never",
    account_pending_label: "Pending changes",
    account_sync_now: "Sync now",
    account_sync_toggle_label: "Sync for this pair",
    account_sync_on: "on",
    account_sync_off: "off",
    account_sign_out: "Sign out",
    account_syncing: "Syncing...",
    account_sync_done: "Sync complete (revision {rev})",
    account_sync_done_toast: "Sync complete",
    account_sync_failed: "Sync failed",
    account_sync_conflict: "Course curriculum conflicts with the cloud; conflict resolution will arrive in a future version. Your changes are kept locally.",
    account_sync_conflict_toast: "Curriculum conflict with the cloud",
    account_relogin_required: "Sign-in required: the server rejected the token.",
    account_sync_block_title: "What is synced",
    account_synced_items: "Syncs: course curriculum (topics), topic progress, session scores, words and phrases (learning items), service metadata.",
    account_not_synced_items: "Not synced: exercise answers and texts, topic notes (reviews), debug dumps, provider settings and API keys.",
    account_bind_checking: "Checking the cloud...",
    account_conflict_title: "Curriculum differs from the cloud",
    account_conflict_topics: "Cloud curriculum: {count} topics",
    account_conflict_adopt: "Use the cloud curriculum",
    account_conflict_replace: "Keep mine and replace the cloud",
    account_conflict_cancel: "Cancel",
    account_progress_merge_title: "Local progress found",
    account_progress_merge_merge: "Merge with the cloud",
    account_progress_merge_cloud: "Start from the cloud, discard local",
    account_adopt_done: "Cloud curriculum adopted ({count} topics)",
    account_replace_done: "Cloud curriculum replaced with yours ({count} topics, revision {rev})",
};
...
const RU_SETTINGS: SettingsLabels = SettingsLabels {
    ...
    account_not_logged_in: "Вход не выполнен.",
    account_sign_in: "Войти",
    account_sign_in_retry: "Повторить вход",
    account_starting: "Начинаем вход...",
    account_code_label: "Код:",
    account_verification_label: "Откройте:",
    account_waiting: "Ожидаем подтверждение в браузере...",
    account_expired: "Код истёк.",
    ...
    account_never_synced: "никогда",
    account_pending_label: "Изменений ожидает",
    account_sync_now: "Синхронизировать сейчас",
    account_sync_toggle_label: "Sync для текущей пары",
    account_sync_on: "вкл",
    account_sync_off: "выкл",
    account_sign_out: "Выйти",
    account_syncing: "Синхронизация...",
    account_sync_done: "Синхронизация завершена (ревизия {rev})",
    account_sync_done_toast: "Синхронизация завершена",
    account_sync_failed: "Ошибка синхронизации",
    account_sync_conflict: "Программа курса конфликтует с облаком; разрешение конфликтов появится в следующей версии. Ваши изменения сохранены локально.",
    account_sync_conflict_toast: "Конфликт программы курса с облаком",
    account_relogin_required: "Требуется повторный вход: сервер отклонил токен.",
    account_sync_block_title: "Что синхронизируется",
    account_synced_items: "Синхронизируются: программа курса (темы), прогресс по темам, оценки сессий, слова и фразы (учебные элементы), служебные метаданные.",
    account_not_synced_items: "Не синхронизируются: ответы и тексты упражнений, конспекты тем (reviews), debug-дампы, настройки и API-ключи провайдеров.",
    account_bind_checking: "Проверяем облако...",
    account_conflict_title: "Программа курса отличается от облачной",
    account_conflict_topics: "Облачная программа: тем {count}",
    account_conflict_adopt: "Взять облачную программу",
    account_conflict_replace: "Оставить свою и заменить облачную",
    account_conflict_cancel: "Отмена",
    account_progress_merge_title: "Найден локальный прогресс",
    account_progress_merge_merge: "Объединить с облачным",
    account_progress_merge_cloud: "Начать с облачного, локальный отбросить",
    account_adopt_done: "Облачная программа применена (тем: {count})",
    account_replace_done: "Облачная программа заменена вашей (тем: {count}, ревизия {rev})",
};
...
pub fn native_language_code(config: Option<&open_course_config::OpenCourseConfig>) -> &str {
    config
